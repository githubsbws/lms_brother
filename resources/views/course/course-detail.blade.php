                ...
                <div class="media v-middle">
                    <div class="media-left">
                        <span class="icon-block s60 bg-default">
                            <img src="/../images/storage/uploads/courseonline/222/small/30082021112832_Picture.jpg" style="height: 60px;" class="img-responsive">
                        </span>
                    </div>
                    <div class="media-body">
                        <h1 class="text-display-1 margin-none">การซ่อมบำรุงเครื่องพิมพ์ฉลาก PT-E850TKW</h1>
                    </div>
                    <div class="media-right">
                        <a class="btn btn-white" style="font-size: 22px;" href="/lms_brother_docker/lms/app/index.php/course/index">รวมหลักสูตร</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated="">
                            <div class="panel-body">
                                <div class="width-300 width-250-md width-50pc-xs paragraph-inline">
                                    <img src="/../images/storage/uploads/courseonline/222/thumb/30082021112832_Picture.jpg" class="img-responsive">
                                </div>
                                <p></p>
                                <p>การซ่อมบำรุงเครื่องพิมพ์ฉลาก PT-E850TKW</p>
                        ...
                        <div class="panel panel-primary paper-shadow" data-z="0.5" data-hover-z="1" data-animated="">
                            ...
                            <div class="panel-body">
                                <p class="text-caption" style="font-size: 22px;">
                                    ...
                                    <i class="fa fa-calendar fa-fw"></i> 30/08/2021 <br><br>
                            ...
                            <div class="panel-body text-center">
                                <p><a class="btn btn-success btn-lg paper-shadow relative" data-z="1" data-hover-z="2" data-animated="" href="{{ url('course/lesson') }}">เริ่มหลักสูตร</a>
                                </p>
                            </div>
