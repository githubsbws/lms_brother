	...
	<!-- Common Demo Script -->
	<script src="{{asset('Adminkit/theme/scripts/demo/common.js?1365412901')}}"></script>
	...
	<script src="{{asset('Adminkit/theme/scripts/demo/index.js?1365412901')}}"></script>
	...
	<script src="{{asset('Adminkit/theme/scripts/demo/charts.helper.js?1365412901')}}"></script>


	<!-- Optional Resizable Sidebars -->
	<!--[if gt IE 8]><!-->
	<script src="{{asset('Adminkit/theme/scripts/demo/resizable.js?1365412901')}}"></script><!--<![endif]-->
