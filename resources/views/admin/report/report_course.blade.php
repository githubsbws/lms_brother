								...
								<table class="table table-striped table-bordered table-condensed dataTable table-primary js-table-sortable ui-sortable">
									<thead>
										<tr>
											...
											<th><a class="sort-link" style="color:white;" href="/admin/index.php/vdo/index?Vdo_sort=vdo_path">รายละเอียดหลักสูตร</a></th>
									...
									<tbody>
										...
										<tr class="odd selectable">
											...
											<td>{{$cs->course_title}}</td>
											<td>{!! htmlspecialchars_decode(htmlspecialchars_decode($cs->course_detail)) !!}</td>
											<td>{{ count($learn) }}</td>
										</tr>
										@endforeach
									</tbody>
