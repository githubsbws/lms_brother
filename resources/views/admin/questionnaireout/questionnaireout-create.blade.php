		...
		<div id="wrapper">
			...
			<div id="content">
				...
				<div class="innerLR">
                            ...
                            <ul>
                                <li class="active">
                                    <a class="glyphicons edit" href="#account-details" data-toggle="tab">
                                        <i></i>เพิ่มหมวดหัวข้อ</a>
                                </li>
                            </ul>
                        </div>
                        <div class="widget-body">
                            <div class="form">
                                <form enctype="multipart/form-data" id="questionnaireout-form" action="/questionnaireout_insert" method="post">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <label for="question_THtopic" class="required">ชื่อหมวดหัวข้อ <span class="required">*</span></label>
                                        <input size="60" maxlength="250" class="span8" name="survey_name" id="question_THtopic" type="text">
                                    </div>
									@error('survey_name')
										<div class="my-2">
                                    ...
                                    <div class="row">
                                        <label for="question_THdetails" class="required">รายละเอียดหัวข้อ<span class="required">*</span></label>
                                        <textarea class="span8" name="instructions" id="question_THdetails" rows="6"></textarea>
                                    </div>
									@error('instructions')
										<div class="my-2">
											<span class="text-primary">{{$message}}</span>
					...
					<div class="row">
						ชื่อกลุ่ม<input size="60" maxlength="250" class="span8" name="survey_name" id="question_THtopic" type="text">
					</div><br>
					<span class="pull-left" style="margin-left: 10px;">
						<a class="btn btn-primary btn-icon glyphicons circle_plus" href="{{ url('/questionnaireout_create') }}"><i></i> เพิ่มหัวข้อ</a>
					</span>
