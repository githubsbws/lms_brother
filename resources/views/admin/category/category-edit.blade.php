                ...
                <div id="content">
                    <ul class="breadcrumb">
                        <li><a href="/admin/index.php">หน้าหลัก</a></li> » <li><a
                                href="/admin/index.php/category/index">ระบบหมวดหลักสูตร</a></li> » <li>เพิ่มหมวดหลักสูตร</li>
                    </ul><!-- breadcrumbs -->
                        ...
                        function upload() {
                            ...
                            if (file) {
                                ...
                                if ($.inArray(get_ext[0].toLowerCase(), exts) > -1) {
                                    ...
                                    $('#Category_cate_image_em_').removeAttr('style').html(
                            ...
                            <div class="widget-body">
                                <div class="form">
                                    ...
                                    <form enctype="multipart/form-data" id="Category-form"
                                        action="{{ route('category-edit-to', $category->cate_id) }}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <input size="60" maxlength="250" class="span8"
                                                value="{{ $category->cate_title }}" name="Category[cate_title]"
                                        ...
                                        <div class="row">
                                            <label for="Category_cate_short_detail" class="required">รายละเอียดย่อ <span
                                                    class="required">*</span></label>
                                            <textarea rows="4" cols="40" class="span8" maxlength="255" name="Category[cate_short_detail]"
                                                id="Category_cate_short_detail">{{ $category->cate_short_detail }}</textarea> <span style="margin:0;"
                                                class="btn-action single glyphicons circle_question_mark"><i></i></span>
                                            <div class="error help-block">
                                        ...
                                        <div class="row">
                                            <label for="Category_cate_detail" class="required">รายละเอียด <span
                                                    class="required">*</span></label>
                                            <div id="mceu_25" class="mce-tinymce mce-container mce-panel" hidefocus="1"
                                                tabindex="-1" role="application"
                                                style="visibility: hidden; border-width: 1px; width: 680px;">
                                                <div id="mceu_25-body" class="mce-container-body mce-stack-layout">
                                                    <div id="mceu_26"
                                                        ...
                                                        <div id="mceu_26-body" class="mce-container-body mce-flow-layout">
                                                            <div id="mceu_27"
                                                                ...
                                                                aria-haspopup="true"><button id="mceu_27-open"
                                                            ...
                                                            <div id="mceu_28"
                                                                ...
                                                                aria-haspopup="true"><button id="mceu_28-open"
                                                            ...
                                                            <div id="mceu_29"
                                                                ...
                                                                aria-haspopup="true"><button id="mceu_29-open"
                                                                    role="presentation" type="button"
                                                                    tabindex="-1"><span class="mce-txt">Insert</span> <i
                                                                        class="mce-caret"></i></button></div>
                                                            <div id="mceu_30"
                                                                class="mce-widget mce-btn mce-menubtn mce-flow-layout-item mce-btn-has-text"
                                                                tabindex="-1" aria-labelledby="mceu_30" role="menuitem"
                                                                aria-haspopup="true"><button id="mceu_30-open"
                                                                    role="presentation" type="button"
                                                                    tabindex="-1"><span class="mce-txt">View</span> <i
                                                                        class="mce-caret"></i></button></div>
                                                            <div id="mceu_31"
                                                                class="mce-widget mce-btn mce-menubtn mce-flow-layout-item mce-btn-has-text"
                                                                tabindex="-1" aria-labelledby="mceu_31" role="menuitem"
                                                                aria-haspopup="true"><button id="mceu_31-open"
                                                                    role="presentation" type="button"
                                                                    tabindex="-1"><span class="mce-txt">Format</span> <i
                                                                        class="mce-caret"></i></button></div>
                                                            <div id="mceu_32"
                                                                class="mce-widget mce-btn mce-menubtn mce-flow-layout-item mce-btn-has-text"
                                                                tabindex="-1" aria-labelledby="mceu_32" role="menuitem"
                                                                aria-haspopup="true"><button id="mceu_32-open"
                                                                    role="presentation" type="button"
                                                                    tabindex="-1"><span class="mce-txt">Table</span> <i
                                                                        class="mce-caret"></i></button></div>
                                                            <div id="mceu_33"
                                                                class="mce-widget mce-btn mce-menubtn mce-flow-layout-item mce-last mce-btn-has-text"
                                                                tabindex="-1" aria-labelledby="mceu_33" role="menuitem"
                                                                ...
                                                                <div id="mceu_41-body"
                                                                    ...
                                                                    <div id="mceu_42"
                                                                        ...
                                                                        <div id="mceu_42-body">
                                                                            <div id="mceu_14"
                                                                                ...
                                                                                role="button" aria-label="Insert file">
                                                                                <button role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                                        class="mce-ico mce-i-browse"></i></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="mceu_43"
                                                                        ...
                                                                        <div id="mceu_43-body">
                                                                            ...
                                                                            <div id="mceu_16" class="mce-widget mce-btn"
                                                                                ...
                                                                                role="button" aria-label="Remove link">
                                                                                <button role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                            ...
                                                                            <div id="mceu_17"
                                                                                ...
                                                                                role="button" aria-label="Anchor"><button
                                                                                    role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                                        class="mce-ico mce-i-anchor"></i></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="mceu_44"
                                                                        ...
                                                                        <div id="mceu_44-body">
                                                                            <div id="mceu_18"
                                                                                class="mce-widget mce-btn mce-first"
                                                                                tabindex="-1" aria-labelledby="mceu_18"
                                                                                role="button"
                                                                            ...
                                                                            <div id="mceu_19"
                                                                                class="mce-widget mce-btn mce-last"
                                                                                tabindex="-1" aria-labelledby="mceu_19"
                                                                                role="button"
                                                                                aria-label="Insert/edit video"><button
                                                                                    role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                                        class="mce-ico mce-i-media"></i></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div id="mceu_45"
                                                                    ...
                                                                    <div id="mceu_46"
                                                                        ...
                                                                        <div id="mceu_46-body">
                                                                            <div id="mceu_22"
                                                                                class="mce-widget mce-btn mce-first"
                                                                                tabindex="-1" aria-labelledby="mceu_22"
                                                                                role="button" aria-label="Print"><button
                                                                                    role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                                        class="mce-ico mce-i-print"></i></button>
                                                                            </div>
                                                                            <div id="mceu_23" class="mce-widget mce-btn"
                                                                                tabindex="-1" aria-labelledby="mceu_23"
                                                                                role="button" aria-label="Preview">
                                                                                <button role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                                                        class="mce-ico mce-i-preview"></i></button>
                                                                            </div>
                                                                            <div id="mceu_24"
                                                                                class="mce-widget mce-btn mce-last"
                                                                                tabindex="-1" aria-labelledby="mceu_24"
                                                                                role="button" aria-label="Source code">
                                                                                <button role="presentation" type="button"
                                                                                    tabindex="-1"><i
                                                    ...
                                                    <div id="mceu_47"
                                                        ...
                                                        style="border-width: 1px 0px 0px;"><iframe
                                                            id="Category_cate_detail_ifr" frameborder="0"
                                                        ...
                                                        <div id="mceu_48-body" class="mce-container-body mce-flow-layout">
                                                            <div id="mceu_49"
                                                                ...
                                                                <div role="button" class="mce-path-item mce-last"
                                                                    data-index="0" tabindex="-1" id="mceu_49-0"
                                                                    aria-level="0">p</div>
                                                            </div><label id="mceu_51"
                                                                class="mce-wordcount mce-widget mce-label mce-flow-layout-item">Words:
                                                                0</label>
                                                            <div id="mceu_50"
                                            ...
                                            <textarea rows="6" cols="50" class="span8 tinymce" name="Category[cate_detail]"
                                        ...
                                        <div class="row">
                                            <div id="vdo_show" style="">
                                                @if ($vdo->count() > 0)
                                                    วิดีโอเดิม <br>
                                                    @foreach ($vdo as $item)
                                                        @if (Str::contains($item->filename, ['.mp4']))
                                                            <!-- Display video -->
                                                            <video controls class="video-item" width="30%"
                                                                id="selected_picture" name="filename_o">
                                                                <source
                                                                    src="{{ asset('storage/vdo/uploads/category/' . $item->filename) }}"
                                                                    type="video/mp4">
                                                            </video>
                                                        @elseif (Str::contains($item->filename, ['.mp3']))
                                                            <!-- Display audio -->
                                        ...
                                        <br>
                                        <div class="row">
                                            <label for="Filecategory_filename" class="required">ไฟล์บทเรียน (mp3,mp4)
                                                <span class="required">*</span></label>
                                            <div id="queue"></div>
                                            <input id="ytfilename" type="file" value=""
                                                name="Filecategory[filename]">
										...
										<script type="text/javascript">
                                            ...
                                            <div class="error help-block">
                                                <div class="label label-important" id="Filecategory_filename_em_"
                                                    style="display:none"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div id="picture_show" style="">
                                                ภาพประกอบ <br>
                                                <img src="{{ asset('../storage/images/uploads/category/' . $category->cate_image) }}"
                                                    alt="รูปภาพ" style="width: 300px; " id="selected_picture"
                                                    value="{{ $category->cate_image }}" name="cate_image_o"><br><br>
                                            </div>
                                        </div>
                                        <br>
                                                ...
                                                <div class="input-append">
                                                    <div class="uneditable-input span3"><i
                                                        ...
                                                        class="btn btn-default btn-file"><span
                                                            ...
                                                            id="ytCategory_cate_image" type="hidden" value=""
                                                            name="Category[cate_image]"><input name="Category[cate_image]"
                                                            id="Category_cate_image" type="file"></span><a
                                                        href="#" class="btn fileupload-exists"
                                                        data-dismiss="fileupload">Remove</a>
                                                </div>
                                            </div>
                                            <div class="error help-block">
                                                <div class="label label-important" id="Category_cate_image_em_"
                                                    style="display:none"></div>
                                            </div>
                                        </div>
