				...
				<div class="innerLR">
					<div class="widget widget-tabs border-bottom-none">
						...
						<div class="widget-body">
							<div class="form">
								{{-- แก้ไข --}}
								<form enctype="multipart/form-data" id="Category-form" action="{{ route('category-edit-to', $category->cate_id) }}" method="post">
									...
									<div class="row">
										...
										<input size="60" maxlength="250" class="span8"  value="{{ $category->cate_title }}" name="Category[cate_title]" id="Category_cate_title" type="text"> <span style="margin:0;" class="btn-action single glyphicons circle_question_mark"><i></i></span>
									...
									<div class="row">
										<label for="Category_cate_short_detail" class="required">รายละเอียดย่อ <span class="required">*</span></label> <textarea rows="4" cols="40" class="span8" maxlength="255" name="Category[cate_short_detail]" id="Category_cate_short_detail">{{ $category->cate_short_detail }}</textarea> <span style="margin:0;" class="btn-action single glyphicons circle_question_mark"><i></i></span>
										<div class="error help-block">
									...
									<div class="row">
										...
										</div><textarea rows="6" cols="50" class="span8 tinymce" name="Category[cate_detail]" id="Category_cate_detail" aria-hidden="true" style="display: none;">{{ $category->cate_detail }}</textarea>
										<div class="error help-block">
