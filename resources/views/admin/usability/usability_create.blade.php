...
<body class="">
	...
	<div class="container-fluid fluid menu-left">
		...
		<div id="wrapper">
			...
			<div id="content">
				<ul class="breadcrumb">
					<li><a href="/admin/index.php">หน้าหลัก</a></li> » <li><a href="/admin/index.php/usability/index">ระบบวิธีการใช้งาน</a></li> » <li>เพิ่มวิธีการใช้งาน</li>
				</ul><!-- breadcrumbs -->
							...
							<ul>
								<li class="active">
									<a class="glyphicons edit" href="#account-details" data-toggle="tab">
										<i></i>เพิ่มวิธีการใช้งาน </a>
								</li>
							</ul>
						</div>
						<div class="widget-body">
							<div class="form">
								<form enctype="multipart/form-data" id="usability-form" action="{{ route('usability.create')}}" method="post">
									@csrf
									...
									<div class="row">
										<label for="Usability_usa_title" class="required">หัวข้อวิธีการใช้งาน <span class="required">*</span></label> <input size="60" maxlength="250" class="span8" name="usa_title" id="Usability_usa_title" type="text"> <span style="margin:0;" class="btn-action single glyphicons circle_question_mark"><i></i></span>
										<div class="error help-block">
											<div class="label label-important" id="Usability_usa_title_em_" style="display:none"></div>
										</div>
									</div>
