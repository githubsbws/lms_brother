                ...
                <div id="content">
                    <ul class="breadcrumb">
                        <li><a href="/admin/index.php">หน้าหลัก</a></li> » <li><a
                                href="/admin/index.php/lesson/index">ระบบบทเรียน</a></li> » <li>เพิ่มบทเรียน</li>
                    </ul><!-- breadcrumbs -->
                            ...
                            <div class="widget-body">
                                <div class="form">
                                    ...
                                    <form enctype="multipart/form-data" id="lesson-form"
                                        action="{{ route('lession-edit-to', $lesson->id) }}" method="post">
                                        {{-- แก้ไข --}}
                                        @csrf
                                        ...
                                        <div class="row">
                                            <label for="Lesson_title" class="required">ชื่อบทเรียน <span
                                                ...
                                                class="span8" name="Lesson[title]" id="Lesson_title" type="text"
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea size="60" maxlength="255" class="span8" name="Lesson[description]" id="Lesson_description">{{ $lesson->description }}</textarea> <span style="margin:0;"
                                                class="btn-action single glyphicons circle_question_mark"><i></i></span>
                                            <div class="error help-block">
                                        ...
                                        <div class="row" style="display:none;">
                                            <label for="Lesson_view_all" class="required">สิทธิ์การดูบทเรียนนี้ <span
                                                    class="required">*</span></label> <select class="span8"
                                                name="Lesson[view_all]" id="Lesson_view_all">
                                        ...
                                        <div class="row">
                                            <label for="Lesson_cate_amount" class="required">จำนวนครั้งที่สามารถทำข้อสอบได้
                                                ...
                                                maxlength="255" class="span8" name="Lesson[cate_amount]"
                                        ...
                                        <div class="row">
                                            <label for="Lesson_time_test">เวลาในการทำข้อสอบ</label> <input size="60"
                                                maxlength="255" class="span8" name="Lesson[time_test]"
                                        ...
                                        <div class="row">
                                            <label for="Lesson_content" class="required">เนื้อหา <span
                                                    class="required">*</span></label>
                                            <div id="mceu_25" class="mce-tinymce mce-container mce-panel"
                                                ...
                                                <div id="mceu_25-body" class="mce-container-body mce-stack-layout">
                                                        ...
                                                        <div id="mceu_26-body" class="mce-container-body mce-flow-layout">
                                                            <div id="mceu_27"
                                                                ...
                                                                aria-haspopup="true"><button id="mceu_27-open"
                                                                    ...
                                                                    tabindex="-1"><span class="mce-txt">File</span> <i
                                                    ...
                                                    <div id="mceu_47"
                                                        ...
                                                        hidefocus="1" tabindex="-1" role="group"
                                                        style="border-width: 1px 0px 0px;"><iframe id="Lesson_content_ifr"
                                            ...
                                            <textarea class="tinymce" name="Lesson[content]" id="Lesson_content" aria-hidden="true" style="">{{ $lesson->content }}</textarea>
                                            <div class="error help-block">
                                                    ...
                                                    @foreach ($vdo as $item)
                                                        @if (Str::contains($item->filename, ['.mp4']))
                                                            ...
                                                            <video controls class="video-item" width="30%"
                                                                ...
                                                                <source
                                                                    src="{{ asset('storage/vdo/uploads/lesson/' . $item->filename) }}"
                                                                    type="video/mp4">
                                                            </video>
                                        ...
                                        <div class="row">
                                            <div id="doc_show" style="">
                                                @if ($doc->count() > 0)
                                                    ไฟล์ประกอบบทเรียน <br>
                                                    @foreach ($doc as $item)
                                                        @if (Str::contains($item->filename, ['.pdf', '.docx', '.pptx']))
                                                            <!-- Display document link -->
                                                            <a href="{{ asset('storage/doc/uploads/lesson/' . $item->filename) }}"
                                                ...
                                                <div class="input-append">
                                                    <div class="uneditable-input span3"><i
                                                        ...
                                                        class="btn btn-default btn-file"><span
                                                            ...
                                                            id="ytLesson_image" type="hidden" value=""
                                                            name="Lesson[image]"><input name="Lesson[image]"
                                                            id="Lesson_image" type="file"></span><a href="#"
                                                        class="btn fileupload-exists" data-dismiss="fileupload">Remove</a>
                                                </div>
                                            </div>
                                            <div class="error help-block">
                                                <div class="label label-important" id="Lesson_image_em_"
                                                    style="display:none"></div>
                                            </div>
                                        </div>
