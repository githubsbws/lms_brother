                            ...
                            <div class="widget-body">
                                <div class="form">
                                    ...
                                    <form enctype="multipart/form-data" id="course-form"
                                        action="{{ route('courseonline-edit-to', $course_detail->course_id) }}"
                                        method="post">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <select class="span8" name="CourseOnline[cate_id]" id="CourseOnline_cate_id">
                                        ...
                                        <div class="row">
                                            ...
                                            <select class="span8" name="CourseOnline[course_lecturer]"
                                                id="CourseOnline_course_lecturer">
                                                <option value="">ทั้งหมด</option>
                                                <option value="{{ $course_detail->course_lecturer }}"
                                                    {{ $course_detail->course_lecturer ? 'selected' : '' }}>
                                                    {{ $course_detail->course_lecturer }}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <input size="60" maxlength="255" class="span8"
                                                name="CourseOnline[course_title]"
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea rows="6" cols="50" class="span8" name="CourseOnline[course_short_title]"
                                                id="CourseOnline_course_short_title">{{ htmlspecialchars($course_detail->course_short_title) }}</textarea>
                                            <span style="margin:0;"
                                        ...
                                        <div class="row">
                                                ...
                                                <div id="mceu_25-body" class="mce-container-body mce-stack-layout">
                                                    ...
                                                    <div id="mceu_47"
                                                        ...
                                                        style="border-width: 1px 0px 0px;"><iframe
                                                            id="CourseOnline_course_detail_ifr" frameborder="0"
                                            ...
                                            <textarea rows="6" cols="50" class="span8 tinymce" name="CourseOnline[course_detail]"
                                                id="CourseOnline_course_detail" aria-hidden="true" style="">{{ htmlspecialchars($course_detail->course_detail) }}</textarea>
                                            <div class="error help-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="toggle-button" data-togglebutton-style-enabled="success"
                                                ...
                                                <input id="ytCourseOnline_recommend" type="hidden" value="n"
                                                    name="CourseOnline[recommend]">
                                                <div style="left: -50%; width: 150px;"><input value="y"
                                                        name="CourseOnline[recommend]" id="CourseOnline_recommend"
                                                        type="checkbox"><span class="labelLeft success"
                                                        style="width: 50px; height: 25px; line-height: 25px;">ON</span><label
                                                        for="CourseOnline_recommend"
                                                        style="width: 50px; height: 25px;"></label><span
                                                        class="labelRight"
                                                        style="width: 50px; height: 25px; line-height: 25px;">OFF </span>
                                                </div>
                                            </div>
                                            <div class="error help-block">
                                        ...
                                        <div class="row">
                                            <label for="CourseOnline_course_note">หมายเหตุ</label> <input size="60"
                                                ...
                                                name="CourseOnline[course_note]" id="CourseOnline_course_note"
                                                type="text">
                                            <div class="error help-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="error help-block">
                                                <div class="label label-important" id="CourseOnline_course_picture_em_"
                                                    style="display:none"></div>
                                            </div>
                                        </div>
