                            ...
                            <div class="panel panel-default paper-shadow" data-z="0.5" style="margin-bottom: 25px;">
                                <div class="panel-body">
                                    <div class="media media-clearfix-xs">
                                        ...
                                        <div class="media-body">
                                            <h4 class="text-headline margin-v-5-0" style="font-size: 28px;"><a href="/lms_brother_docker/lms/app/index.php/news/index/78" title="วิธีการใช้งาน TS-Chatbot">วิธีการใช้งาน TS-Chatbot</a></h4>

                                            <p style="color: rgb(33, 33, 33);">อธิบาย ขั้นตอนการใช้งานเมนูทั้ง 3 ของ TS-Chatbot บน Application LINE
